...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-center my-2">
                                ...
                                <a style="font-size: 10px; border:0px; background:red"
                                    ...
                                    href="cancle-tella-sms?id={{ $sms_order->order_id }}" role="button"><i class=""> Delete
                                        Order</a></i>
        ...
        <script>
            ...
            const timerInterval = setInterval(() => {
                ...
                if (countdown <= 0) {
                    ...
                    window.location.href = '{{ url('') }}/check-tellasms?mdn={{ $sms_order->phone}}'; // Replace with your desired URL
                }
            }, 1000);
    ...
    const fullUrl = '{{ url('') }}/get-tella-smscode?mdn={{ $sms_order->phone }}';
    ...
    fetch(fullUrl)
        .then(response => {
            ...
            // Try to parse JSON, catch errors if it fails
        ...
        .then(data => {
            ...
            if (data && data.message) {
                ...
                displayResponse('No message found in response.');
            }
        })
        .catch(error => {
            console.error('Fetch error:', error.message);
            displayResponse({ error: `An error occurred: ${error.message}` });
        });
}
